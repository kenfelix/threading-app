...
export function WelcomePage() {
  ...
  console.log(connected,isMember)
  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-[13px]">
        <Button large rounded touchRipple className="!text-white" disabled={connected === false || (connected === true && isMember === true) || (connected === true && isMember === undefined)} colors={{ disabledBg: "bg-grey" }} onClick={() => {
